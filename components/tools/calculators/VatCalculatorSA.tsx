...
export default function VatCalculatorSA() {
  ...
  return (
    <div className="space-y-6" dir="rtl">
      <div className="bg-primary/10 rounded-xl p-4 text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">نسبة ضريبة القيمة المضافة في السعودية</p>
      </div>
      ...
      {result && (
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-primary/10 rounded-xl p-4 text-center">
              <p className="text-sm text-gray-500 mb-1">الضريبة (15%)</p>
