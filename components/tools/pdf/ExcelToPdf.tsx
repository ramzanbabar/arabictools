...
export default function ExcelToPdf() {
  ...
  const convert = async () => {
    ...
    setConverting(true);
    alert("تحويل Excel إلى PDF يتطلب معالجة على الخادم. هذه الميزة قيد التطوير.");
    setConverting(false);
  };
  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      >
        <input {...getInputProps()} />
        <p className="text-lg">اسحب ملف Excel هنا أو انقر للاختيار</p>
        <p className="text-sm text-gray-500 mt-2">.xls أو .xlsx</p>
      </div>
